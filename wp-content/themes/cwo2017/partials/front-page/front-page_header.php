        ...
        <div class="front-page_header_top bg-std bg-dude mobile-bg">
            <div class="container">
                <div class="row front-page_header_content_wrapper">
                    ...
                    <!-- Images -->
                    <div class="col-sm-4 col-md-3 hidden-xs front-page_header_images pos-rel">
                    ...
                    <div class="col-sm-4 col-md-4 hidden-xs">
                        <div class="front-page_header_next_event desktop bg-pommes text-center puffer-both-sm">
                            <p class="font-demon fontsize-headline gap-bottom-md">Samstag 18.02.2017</p>
                            <h2 class="font-demon fontsize-headline-big color-black gap-bottom-sm">Steel Crusade 31</h2>
                            <p class="gap-bottom-sm">
