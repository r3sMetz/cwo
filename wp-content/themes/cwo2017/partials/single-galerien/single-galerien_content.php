<div class="single-galerien_content fullPageElement flexed_center puffer-both-xl margin-top-mobile" id="the_gallery_wrapper">
	<div class="container">
		<!-- Big Slider (Top) -->
		...
		<div class="row pos-rel">
			<div class="col-md-8 col-md-offset-2 the_small_slider galery_slider">
				<?php foreach(get_field('galerie_verwalten') as $image):?>
					<img class="pull-left maxImage" src="<?php echo $image['url'];?>" alt="<?php the_title();?>">
				<?php endforeach;?>
			</div>
