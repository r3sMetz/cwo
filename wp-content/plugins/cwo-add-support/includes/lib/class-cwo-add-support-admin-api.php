...
class CWO_Add_Support_Admin_API {
	...
	public function display_field ( $data = array(), $post = false, $echo = true ) {
		...
		switch( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image' , 'cwo-add-support' ) . '" data-uploader_button_text="' . __( 'Use image' , 'cwo-add-support' ) . '" class="image_upload_button button" value="'. __( 'Upload new image' , 'cwo-add-support' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="'. __( 'Remove image' , 'cwo-add-support' ) . '" />' . "\n";
