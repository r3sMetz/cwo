...
Installing "CWO Add Support" can be done either by searching for "CWO Add Support" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
